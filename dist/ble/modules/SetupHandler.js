...
class SetupHandler {
    ...
    setup(sphereUid, crownstoneId, meshAccessAddress, meshDeviceKey, ibeaconUUID, ibeaconMajor, ibeaconMinor) {
        return new Promise((resolve, reject) => {
            ...
            if (this.ble.connectedPeripheral.characteristics[Services_1.CSServices.SetupService][Characteristics_1.SetupCharacteristics.SetupControlV2]) {
                resolve(this._performFastSetupV2(sphereUid, crownstoneId, meshDeviceKey, ibeaconUUID, ibeaconMajor, ibeaconMinor));
            }
            else if (this.ble.connectedPeripheral.characteristics[Services_1.CSServices.SetupService][Characteristics_1.SetupCharacteristics.SetupControl]) {
    ...
    _commandSetupV2(sphereUid, crownstoneId, adminKey, memberKey, basicKey, serviceDataKey, localizationKey, meshNetworkKey, meshAppKey, meshDeviceKey, ibeaconUUID, ibeaconMajor, ibeaconMinor) {
        ...
        return this.ble.writeToCharacteristic(Services_1.CSServices.SetupService, Characteristics_1.SetupCharacteristics.SetupControlV2, packet);
    }

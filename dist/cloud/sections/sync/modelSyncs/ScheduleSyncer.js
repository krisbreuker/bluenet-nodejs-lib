...
const transferSchedules_1 = require("../../../transferData/transferSchedules");
const Util_1 = require("../../../../util/Util");
const syncUtil_1 = require("../shared/syncUtil");
const SyncingBase_1 = require("./SyncingBase");
class ScheduleSyncer extends SyncingBase_1.SyncingSphereItemBase {
    constructor(actions, transferPromises, localSphereId, cloudSphereId, localStoneId, cloudStoneId, globalCloudIdMap, globalSphereMap) {
    ...
    syncDown(schedulesInState, schedulesInCloud) {
        ...
        schedulesInCloud.forEach((schedule_from_cloud) => {
            ...
            if (localId) {
                ...
                localScheduleIdsSynced[localId] = true;
                // add schedule
                this.transferPromises.push(transferSchedules_1.transferSchedules.createLocal(this.actions, {
                    localId: localId,
    ...
    syncUp(schedulesInState, localScheduleIdsSynced) {
        ...
        scheduleIds.forEach((scheduleId) => {
            ...
            this.syncLocalScheduleUp(scheduleId, schedule, localScheduleIdsSynced[scheduleId] === true);
        });
    }
    syncLocalScheduleUp(localId, scheduleInState, hasSyncedDown = false) {
        ...
        if (!hasSyncedDown) {
            if (scheduleInState.cloudId) {
                ...
                this.transferPromises.push(transferSchedules_1.transferSchedules.createOnCloud(this.actions, {
                    localId: localId,
    ...
    syncLocalScheduleDown(localId, scheduleInState, schedule_from_cloud) {
        if (syncUtil_1.shouldUpdateInCloud(scheduleInState, schedule_from_cloud)) {
            // update cloud since local data is newer!
            this.transferPromises.push(transferSchedules_1.transferSchedules.updateOnCloud({
                cloudStoneId: this.cloudStoneId,
                localId: localId,
        ...
        else if (syncUtil_1.shouldUpdateLocally(scheduleInState, schedule_from_cloud)) {
            // update local
            this.transferPromises.push(transferSchedules_1.transferSchedules.updateLocal(this.actions, {
                localSphereId: this.localSphereId,
                localStoneId: this.localStoneId,
                localId: localId,
                cloudData: schedule_from_cloud
...
exports.ScheduleSyncer = ScheduleSyncer;
//# sourceMappingURL=ScheduleSyncer.js.map
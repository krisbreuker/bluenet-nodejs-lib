...
exports.transferUtil = {
    ...
    _handleLocal: function (actions, actionType, ids, data, fieldMap) {
        return new Promise((resolve, reject) => {
            if (!data.cloudData) {
                reject("Transfer: No cloud data available! Tried: " + actionType);
            }
            let payload = {};
            exports.transferUtil.fillFieldsForLocal(payload, data.cloudData, fieldMap);
            ...
            let actionPayload = Object.assign({ type: actionType, data: payload }, ids);
            actions.push(actionPayload);
            resolve();
        });
    }
};
//# sourceMappingURL=transferUtil.js.map